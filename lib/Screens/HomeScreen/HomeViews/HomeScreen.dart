...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SmartRefresher(
      controller: hctrl.refreshController,
      onRefresh: () {
        hctrl.reloadData();
      },
          ...
          child: GetBuilder<HomeController>(builder: (_) {
            return Column(
              ...
              children: [
                      ...
                      items: [
                        ...
                        if (hctrl.contentModel == null)
                          ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                            child: Image.asset(
                              "lib/Base/Assets/Images/ad2_m1fwqs.png",
                              fit: BoxFit.fill,
                            ),
                          ),
                        if (hctrl.contentModel == null)
                          ClipRRect(
                            borderRadius: BorderRadius.circular(10),
                            child: Image.asset(
                              "lib/Base/Assets/Images/ad1_dbyple.png",
                              fit: BoxFit.fill,
                            ),
                          ),
                      ],
                ...
                if (hctrl.TopMenu == 0 && !hctrl.OfferLoading)
                  OfferView(
                    OfferList: hctrl.offerList,
                  ),
                if (hctrl.TopMenu == 1 && !hctrl.OfferLoading) JobOfferView(),
                if (hctrl.TopMenu == 2 && !hctrl.OfferLoading) StoreOfferView(),
                SizedBox(
                  height: 8.h,
                )
              ],
