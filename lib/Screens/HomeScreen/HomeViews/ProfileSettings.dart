...
class ProfileSettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(builder: (_) {
      return GetBuilder<GameController>(builder: (__) {
        return Container(
          width: 100.w,
          height: 100.h,
          color: Colors.white,
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      color:
                                          Appc.PrimaryColor.withOpacity(.08)),
                                  child: Image.asset(
                        ...
                        if (false)
                          InkWell(
                            onTap: () {
                              launchUrl(Uri.parse("https://www.showmydeals.in"),
                                  mode: LaunchMode.externalApplication);
                            },
                            child: Text(
                              "FAQ",
                        ...
                        InkWell(
                          onTap: () {
                            launchUrl(Uri.parse("https://showmydeals.in/about"),
                                mode: LaunchMode.externalApplication);
                          },
                          child: Text(
                            "ABOUT US",
                        ...
                        InkWell(
                          onTap: () {
                            launchUrl(
                                Uri.parse("https://www.showmydeals.in/terms"),
                                mode: LaunchMode.externalApplication);
                          },
                          child: Text(
                            "TERMS OF USE",
